  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        {/* BACKGROUND OVERLAY */}
        <div
          className="fixed inset-0 bg-white-900 bg-opacity-75 transition-opacity"
          aria-hidden="true"
          onClick={(e) => {
            // ONLY close if the user clicks the gray background itself
        ...
        <div
          ...
          onClick={(e) => e.stopPropagation()} // Stop any clicks inside from reaching the overlay
        >
